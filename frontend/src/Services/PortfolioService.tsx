...
import { PortfolioAddtDelete } from "../Models/PortfolioPost";
...
export const portfolioAddApi = async (symbol: string) => {
    try{
        ...
        const result = await axios.post<PortfolioAddtDelete>(apiEndpoint + `?symbol=${symbol}`, {}, 
            {
...
export const portfolioDeleteApi = async (symbol: string) => {
    try{
        ...
        const result = await axios.delete<PortfolioAddtDelete>(apiEndpoint + `?symbol=${symbol}`, {
