...
// Component rendered in CompanyPage.tsx (http://localhost:3000/company/:ticker)
const Sidebar = (props: Props) => {
    ...
    /* <Link to="company-profile"> is relative link which is equal to current_url/company-profile, where current_url is http://localhost:300/company/:ticker as Sidebar is rendered on CompanyPage
    Ovo je omoguceno u Routes.tsx jer company-profile is child route for CompanyPage. */
    return (
