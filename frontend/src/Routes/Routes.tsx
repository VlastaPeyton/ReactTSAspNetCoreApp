...
Ovo necu koristiti, vecu cu lazy loading koristiti zbog route-level code splitting. Da se ocita samo stranica koja je zatrazena u browseru cime se smanjuje Bundle i brze se inicijalno otvara app.
*/ 
...
/* Helper component to wrap lazy components with Suspense. React.ReactNode znaci da ce Component biti inside <LazyWrapper>
...
/* Routes.tsx se koristi u index.tsx ! 
    ...
    createBrowserRouter je noviji nacin da napravim Routes u odnosu sto bih u App.tsx stavio <Routes> <Route path="/" element={<HomePage />} /> .... </Routes> kao u ReactApp projektu sto sam uradio.
